O grupo deverá eleger um integrante para enviar o projeto construído (zip ou arquivos .Java). Além disso, deve anexar na atividade um documento contendo Nome + RA dos integrantes e Tema da ODS escolhido.
